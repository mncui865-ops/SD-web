...
def add_notification(username, notif_type, title, body, link='', icon=''):
    """إضافة إشعار مع وقت الإرسال والاستلام"""
        ...
        <div class="pub-timeline" style="max-width:780px; margin:0 auto;">
            ...
            <div class="pub-card">
                ...
                <div class="pub-footer">
                    <div class="pub-date">
                        {{ icons.clock|safe }} <b>وقت الإرسال:</b> {{ m.created_at }}
                    </div>
                    <div class="pub-tags">
...
def messages():
    ...
    # احسب الأيام المتبقية لكل رسالة
    for m in msgs:
        try:
            created = datetime.fromisoformat(m['created_at_iso'])
            if created.tzinfo is None:
    ...
    <section class="section">
        <div class="container" style="max-width:800px;">
            ...
            <div class="form-wrapper" style="max-width:100%; margin:0;">
                ...
                <p>عند إرسال رسالة، يمكنك إرفاق حتى 5 صور. الصور تُضغط تلقائياً.</p>
            </div>
        </div>
    </section>
    """)
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("✓ تطبيق خليك واضح v6.0 يعمل على:")
    print("   🌐 http://localhost:5000")
    print("=" * 60)
    print("✨ الميزات الجديدة في v6.0:")
