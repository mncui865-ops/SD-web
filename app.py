...
النسخة النهائية v4.2 - إصلاح رفع صورة البروفايل
============================================================
"""
...
def is_valid_avatar(avatar):
    """
    ✅ إصلاح: أصبحت أكثر تسامحاً مع Data URIs
    """
    if not avatar:
        return False
...
def validate_image_data_uri(data_uri):
    """
    ✅ إصلاح: ترجع (data_uri, error_message) لعرض السبب الحقيقي للمستخدم
    """
    if not data_uri:
        return '', 'لا توجد صورة'
...
def edit_profile():
    ...
    if request.method == 'POST':
        ...
        # ✅ إصلاح: التحقق من الصورة مع عرض السبب الحقيقي
    ...
    <script>
    // ✅ إصلاح: ضغط ذكي مع محاولات متعددة لضمان حجم مناسب
    function compressToLimit(img, maxSize, callback) {
        ...
        // جرّب جودات مختلفة من الأعلى للأدنى
    ...
    function handleFileUpload(input) {
        ...
        reader.onload = e => {
            const img = new Image();
            img.onload = () => {
                // ✅ استخدم ضغط ذكي (الحد 5MB لترك هامش للبيانات)
    ...
    <section class="section">
        <div class="container" style="max-width:800px;">
            ...
            <div class="form-wrapper" style="max-width:100%; margin:0;">
                ...
                <p>من صفحة "تعديل"، اختر صورة جاهزة أو ارفع صورة من جهازك. سيتم ضغط الصورة تلقائياً لتناسب الحجم المسموح.</p>
...
if __name__ == '__main__':
    print("=" * 60)
    print("✓ تطبيق خليك واضح v4.2 يعمل على:")
    print("   🌐 http://localhost:5000")
    print("=" * 60)
    print("✨ الإصلاحات في v4.2:")
    print("   • إصلاح مشكلة رفع صورة البروفايل")
    print("   • ضغط ذكي متعدد المراحل للصور الكبيرة")
    print("   • رسائل خطأ واضحة تعرض السبب الحقيقي")
    print("   • دعم صيغة JPG (كانت مفقودة)")
    print("   • إصلاح مشكلة الصورة الافتراضية عند الفشل")
    print("=" * 60)
